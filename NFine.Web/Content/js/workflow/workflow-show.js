...
var wf_connColor = "#7e7e7f";
var wf_connColor1 = "green";
var wf_nodeBorderColor = "#7e7e7f";
...
{
    var json = $.ajax({ url: "/Platform/WorkFlow/Designer/GetJSON?type=0&appid=&flowid=" + id, async: false, cache: false, dataType: "json", success: function (json)
    {
        reloadFlow(json);
    }
    });
